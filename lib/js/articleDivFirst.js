...
function Div1(articleFirst) {
	...
	['PHP로 개발을 시작해 Node.js를 거쳐, 현재는 Java/Spring Boot로 백엔드를 개발하고 있습니다.', 
	'',
	'엔트위즈소프트에서 2년 6개월간 근무하며 Cafe24 연동 시스템, ERP 이벤트 관리 플랫폼 등을 개발했고, RESTful API 설계부터 데이터 처리, 유지보수까지 백엔드 전반의 실무를 경험했습니다.', 
	'',
